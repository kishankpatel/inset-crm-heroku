module ContactsHelper
  ...
  def get_contact_activities contact_type, contact_id
    ...
    #activity_data
    activities = []
    decrypt_contact_id(contact_id, contact_type)
    if contact_type == "CompanyContact"
      c = CompanyContact.find @c_id
    elsif contact_type == "IndividualContact"
      c = IndividualContact.find @c_id
    end
  ...
  def decrypt_contact_id id, type
    if id.present? && type == "CompanyContact"
      @c_id = CompanyContact.to_decrypt_key id
    else
      @c_id = IndividualContact.to_decrypt_key id
    end
    return @c_id
  end
end
