class InsertActivities
 ...
 record.user.id : "") : (record.assigned_user.present? ? record.assigned_user.id : ""), :activity_type=> activity_type, :activity_id => activity_id, :activity_status => "Assign",:activity_desc=>activity_desc,:activity_date => activity_date, :is_public => public_status, :source_id => record.id,:source_type=>record.class.name)
          ...
          a1 = Activity.create(:organization_id => org_id,	:activity_user_id => activity_user_id,:activity_type=> activity_type, :activity_id => activity_id, :activity_status => activity_status,:activity_desc=>activity_desc,:activity_date => activity_date, :is_public => public_status, :source_id => record.id,:source_type=>record.class.name)
