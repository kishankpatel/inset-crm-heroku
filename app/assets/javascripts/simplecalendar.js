  ...
  startCalendar: function() {
    var mon = 'Mon';
		...
		$('tbody.event-calendar td').on('click', function(e) {
			$('#task_loader').show();
			$('tbody.event-calendar td').removeClass('current-day');
			$(this).addClass('current-day');
			var eventMonth = $(this).attr('date-month');
			var eventDay = $(this).attr('date-day');
			var eventYear = $(this).attr('date-year');
			var select_date = $(this).attr('date-day') + "-" + $(this).attr('date-month') + "-" + $(this).attr('date-year')
			$.ajax( {
		      type: "GET",
		      url: "get_day_reminder",
		      data: {selected_date: select_date},
		      success: function(result) {
		      },
		      error: function(data) {
         	  },
	          complete: function(data) {
	            $('#get_today_reminders').html(data.responseText);
	            $('#task_loader').hide();
	          }
		    });
