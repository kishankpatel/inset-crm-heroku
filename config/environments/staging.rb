...
SalesCafe::Application.configure do
 ...
 #Serving gzip assets from rails app 
  ...
  #config.action_mailer.default_url_options = { :host => 'dev-saas.wakeupsales.com' }  
...
config.assets.paths << "#{Rails.root}/vendor/assets/homer"
config.middleware.use ExceptionNotifier,
   :email_prefix => "InSetCRM::STAGING::Exception:-  ",
   :sender_address => %{"Exception Notifier" <Okfinemb@gmail.com>},
   :exception_recipients => %w{krishna.sahoo@andolasoft.com}
end
