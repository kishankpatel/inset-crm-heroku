module TasksHelper
  ...
  def get_tasks(taskable=nil, taskable_id=nil)
    ...
    elsif taskable == "IndividualContact"
      taskable_obj = IndividualContact.find taskable_id
    elsif taskable == "CompanyContact"
      taskable_obj = CompanyContact.find taskable_id
